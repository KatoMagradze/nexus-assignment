...
export const PersonCard: React.FC<IPersonCard> = ({
  ...
  return (
    <div
      className={
        "text-center max-w-[380px] h-[268px] p-10 bg-primary-light border-2 border-primary rounded-3xl flex flex-col justify-center items-center"
      }
    >
      <img
        src={image}
        alt={""}
        className={"w-[86px] h-[86px] rounded-[10px] object-cover mt-[-85px]"}
      />
